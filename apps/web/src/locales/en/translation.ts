export default {
  ...
  modals: {
    ...
    createCard: {
      ...
      questionCodeLabel: "Question Code",
      answerCodeLabel: "Answer Code",
      addImageFileLabel: "Add Image File",
      editQuestionFile: "Edit Question File",
      addQuestionFile: "Add Question File",
      editAnswerFile: "Edit Answer File",
      addAnswerFile: "Add Answer File",
