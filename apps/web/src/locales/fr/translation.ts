export default {
  ...
  modals: {
    ...
    createCard: {
      ...
      questionCodeLabel: "Code question",
      answerCodeLabel: "Code réponse",
      addImageFileLabel: "Ajouter un fichier image",
      editQuestionFile: "Modifier le fichier question",
      addQuestionFile: "Ajouter un fichier question",
      editAnswerFile: "Modifier le fichier réponse",
      addAnswerFile: "Ajouter un fichier réponse",
